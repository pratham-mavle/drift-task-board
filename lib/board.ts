...
export const DEMO_STORAGE_KEY = "driftboard-demo-workspace-v3";
...
export function createDemoWorkspace(): WorkspaceSnapshot {
  ...
  const labels: Label[] = [
    { id: "label-launch", name: "Launch", color: "#5B5BD6", createdAt: timeAtOffset(-200) },
    { id: "label-content", name: "Content", color: "#8A5CB8", createdAt: timeAtOffset(-190) },
    { id: "label-bug", name: "Bug", color: "#D96C52", createdAt: timeAtOffset(-180) },
    { id: "label-customer", name: "Customer", color: "#2D8C73", createdAt: timeAtOffset(-170) },
  ];

  const tasks: Task[] = [
    {
      id: "task-support",
      title: "Confirm launch-day support roster",
      description: "Make sure the support handoff covers every region.",
      status: "todo",
      priority: "high",
      dueDate: dateAtOffset(1),
      position: 1000,
      assigneeIds: ["member-maya"],
      labelIds: ["label-launch", "label-customer"],
      createdAt: timeAtOffset(-96),
      updatedAt: timeAtOffset(-8),
    },
    {
      id: "task-faq",
      title: "Finalize pricing FAQ",
      description: "Resolve the remaining questions about annual billing and upgrades.",
      status: "todo",
      priority: "normal",
      dueDate: dateAtOffset(5),
      position: 2000,
      assigneeIds: ["member-ana", "member-dev"],
      labelIds: ["label-content", "label-customer"],
      createdAt: timeAtOffset(-78),
      updatedAt: timeAtOffset(-12),
    },
    {
      id: "task-help-center",
      title: "Prepare the help-center article",
      description: "Document the new plans and the upgrade path.",
      status: "todo",
      priority: "low",
      dueDate: null,
      position: 3000,
      assigneeIds: ["member-dev"],
      labelIds: ["label-content"],
      createdAt: timeAtOffset(-64),
      updatedAt: timeAtOffset(-19),
    },
    {
      id: "task-safari",
      title: "QA the upgrade flow in Safari",
      description: "Safari 17 loses focus after the checkout modal closes.",
      status: "in_progress",
      priority: "high",
      dueDate: dateAtOffset(-1),
      position: 1000,
      assigneeIds: ["member-jules", "member-maya"],
      labelIds: ["label-bug", "label-launch"],
      createdAt: timeAtOffset(-120),
      updatedAt: timeAtOffset(-2),
    },
    {
      id: "task-email",
      title: "Review the announcement email",
      description: "Check the final audience segments, links, and send time.",
      status: "in_progress",
      priority: "normal",
      dueDate: dateAtOffset(3),
      position: 2000,
      assigneeIds: ["member-dev"],
      labelIds: ["label-content", "label-launch"],
      createdAt: timeAtOffset(-110),
      updatedAt: timeAtOffset(-4),
    },
    {
      id: "task-legal",
      title: "Get legal sign-off on pricing",
      description: "Confirm the revised renewal language before publication.",
      status: "in_review",
      priority: "high",
    ...
    {
      id: "task-finance",
      title: "Confirm annual price with finance",
      description: "Verify the final amount and rounding used on the pricing page.",
      status: "in_review",
      priority: "normal",
    ...
    },
    {
      ...
      description: "Share the final summary with customers and the support team.",
      status: "done",
      priority: "normal",
      dueDate: dateAtOffset(-3),
      position: 1000,
  ...
  const comments: TaskComment[] = [
    {
      id: "comment-one",
      taskId: "task-safari",
      body: "Safari 17 still loses focus after the checkout modal closes.",
      createdAt: timeAtOffset(-7),
    },
    {
      id: "comment-two",
      taskId: "task-safari",
      body: "I can reproduce it only when the password manager extension is enabled.",
      createdAt: timeAtOffset(-3),
    },
    {
      id: "comment-three",
      taskId: "task-legal",
      body: "Legal approved the revised wording. Finance still needs to confirm the annual price.",
